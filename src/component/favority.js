...
import { StyleSheet, Text, View, Image, ImageBackground, KeyboardAvoidingView, Dimensions, TouchableOpacity, FlatList,AsyncStorage } from 'react-native';
...
export default class favority extends React.Component {
    ...
    getData = async () =>{
        ...
        fetch(`http://aajo.in/public/api/favouriteoffers/${value}`)
