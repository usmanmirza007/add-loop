...
import { StyleSheet, Picker, Text, View, Image, ImageBackground, AsyncStorage, Alert, Dimensions, TouchableOpacity, } from 'react-native';
...
export default class home2 extends React.Component {
    ...
    View = async () => {
        ...
        await AsyncStorage.getItem('ID').then(id => {
            ...
            fetch(`http://aajo.in/public/api/gettotalview/${id}`, {
                ...
                .then((responseJson) => {
                    ...
                    if (responseJson.success === '1') {
                        this.setState({view: responseJson.count})
    ...
    Publish = async () => {
        ...
        await AsyncStorage.getItem('ID').then(id => {
            console.log("offer id", id)
            fetch(`http://aajo.in/public/api/gettotalactiveoffers/${id}`, {
                ...
                .then((responseJson) => {
                    console.log("response", responseJson.count);
                    if (responseJson.success === '1') {
                        this.setState({publish: responseJson.count})
                        // this.props.navigation.navigate('#')
                        // Alert.alert('successfully')
                    }
                })
    ...
    shopper = async () => {
        ...
        await AsyncStorage.getItem('ID').then(id => {
            console.log("offer id", id)
            fetch(`http://aajo.in/public/api/gettotalshoppers/${id}`, {
                ...
                .then((responseJson) => {
                    console.log("response", responseJson.count);
                    if (responseJson.success === '1') {
                        this.setState({shopers: responseJson.count})
                        // this.props.navigation.navigate('#')
                        // Alert.alert('successfully')
                    }
                })
    ...
    render() {
        const{view, publish,  shopers} = this.state
        return (
                ...
                <ScrollView>
                    ...
                    <View style={styles.mainBox}>
                        ...
                        <View style={styles.box}>
                            ...
                            <Text style={styles.number}>{publish} </Text>
                    ...
                    <View style={styles.mainBox}>
                        ...
                        <View style={styles.box}>
                            ...
                            <Text style={styles.number}>{shopers} </Text>

                        </View>
                    </View>
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => this.props.navigation.navigate('createOffer')}>
